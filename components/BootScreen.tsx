      ...
      {!done && (
        <motion.div
          ...
          style={{
            ...
            padding: '10vh clamp(10px, 5vw, 12vw)',
            overflow: 'hidden',
          }}
        >
          ...
          {/* Top border line */}
          <div style={{
            position: 'absolute', top: '8vh', left: 'clamp(10px, 5vw, 10vw)', right: 'clamp(10px, 5vw, 10vw)',
            borderTop: '1px solid rgba(57,255,20,0.3)',
            display: 'flex', justifyContent: 'space-between',
            paddingTop: 8, gap: 8,
          }}>
            <span style={{ color: 'rgba(57,255,20,0.5)', fontSize: 'clamp(8px, 2.4vw, 10px)', fontFamily: 'Share Tech Mono, monospace', letterSpacing: 2 }}>
              CHA.OS v1.0.0
            </span>
            <span style={{ color: 'rgba(57,255,20,0.5)', fontSize: 'clamp(8px, 2.4vw, 10px)', fontFamily: 'Share Tech Mono, monospace', letterSpacing: 2 }}>
              BOOT SEQUENCE
          ...
          {/* Progress bar */}
          <div style={{
            position: 'absolute', bottom: '10vh', left: 'clamp(10px, 5vw, 10vw)', right: 'clamp(10px, 5vw, 10vw)',
            zIndex: 1,
          }}>
            <div style={{
              display: 'flex', justifyContent: 'space-between', marginBottom: 6,
              fontFamily: 'Share Tech Mono, monospace', fontSize: 'clamp(8px, 2.2vw, 10px)',
              color: 'rgba(57,255,20,0.5)', letterSpacing: 2,
            }}>
            ...
            <div style={{
              ...
              paddingTop: 8, display: 'flex', justifyContent: 'space-between', gap: 8,
            }}>
              <span style={{ fontFamily: 'Share Tech Mono, monospace', fontSize: 'clamp(7px, 2vw, 9px)', color: 'rgba(57,255,20,0.3)', letterSpacing: 2 }}>
                ▲▼ : NAVIGATE
              </span>
              <span style={{ fontFamily: 'Share Tech Mono, monospace', fontSize: 'clamp(7px, 2vw, 9px)', color: 'rgba(57,255,20,0.3)', letterSpacing: 2 }}>
                OK : SELECT
