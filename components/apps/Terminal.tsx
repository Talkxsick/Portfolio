  ...
  return (
    <Window id="terminal" title="Terminal" icon=">_" num="01" width={660} height={420}>
      <div style={{ height: '100%', cursor: 'text', display: 'flex', flexDirection: 'column' }}
        ...
        <div style={{ flex: 1, overflow: 'auto', lineHeight: 1.8, WebkitOverflowScrolling: 'touch' }}>
        {lines.map((line, i) => (
  <div
    key={i}
    style={{
...
>
  ...
  <input
              ...
              onKeyDown={onKeyDown} autoFocus={!isMobile}
              style={{ background: 'transparent', border: 'none', outline: 'none', color: '#ffffff', fontFamily: 'Share Tech Mono, monospace', fontSize: isMobile ? 16 : 12, flex: 1, caretColor: '#7c3aed' }}
            />
          </div>
          <div ref={bottomRef} />
        </div>
